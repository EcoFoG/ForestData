...
# save(data, file="extracparacou2df12022019.rda")
# load("extracparacou2df12022019.rda")
...
for(i in ids){
  ...
  g1 <- temp %>%
    ...
    theme(axis.text.x = element_text(angle=45))+ggrepel::geom_text_repel(aes(label =  Ctype),
                                                                         size = 3)
  # g1
  ggsave(g1, filename = paste0("./corrected_size_trees2/compare3/g_corrected_size_",i,".jpeg"),device = "jpeg")
