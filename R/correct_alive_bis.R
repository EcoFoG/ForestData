...
#' @param time_col character - The name of the column containing census time indication (generally, year)
#' @param alive_col character - The name of the column containing tree life status (1=alive, 0=dead)
#' @param dead_confirmation_censuses Integer - Number of censuses necessary to consider a tree as dead.
#' @param flag_corrections Logical - if true, create a column to flag corrected lines and enable traceback
#'
#' @return
#' @export
#'
...
# Recalculate status column from circ or diam measurements: loop o --------
...
# Recalculate status from circ or diam measurements: individual tr --------
